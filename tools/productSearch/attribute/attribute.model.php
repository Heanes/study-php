...
class Attribute{
	public static function getParentList($pid = 0,$cascade = true){
		global $db;
		$sql = "SELECT id,name,ordering FROM `ju_attributes` WHERE parent=".(int)$pid." ORDER BY ordering";
	...
	public static function save($data = array()){
		...
		$sql = "INSERT INTO `ju_attributes`(`id`,`name`,`parent`,`ordering`) VALUES(null,'$name','$parent','$order')";
